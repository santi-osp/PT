...
public sealed record ResidentialCustomerResponse(
    ...
    string FullName, string FirstNames, string LastNames, string? Phone, string? MobilePhone, string? Email,
    DocumentType DocumentType, string DocumentNumber, string? VerificationDigit, TaxClass TaxClass,
    string PaymentCondition, short Stratum, Guid CenterId, bool IsBlocked, AddressResponse Address,
    DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt)
{
    public static ResidentialCustomerResponse From(ResidentialCustomer customer) => new(
        ...
        customer.FullName, customer.FirstNames, customer.LastNames, customer.Phone, customer.MobilePhone,
